 ...
 * @dev ERC721 NFT contract with UUPS upgradeable pattern
 */
contract UpgradeableNFT is Initializable, UUPSUpgradeable {
    // ERC721 storage (following upgradeable storage pattern)
